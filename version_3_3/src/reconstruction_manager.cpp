...
:the_input_output_manager(an_input_output_manager), the_cluster_manager(0), the_transformation_manager(0), the_geometry(0), the_input_root_file(0), the_input_ssd_energy_tree(0), the_input_particle_truth_tree(0), the_input_steps_truth_tree(0), the_input_root_data_structure(0), the_output_data_structure(0),
    the_histogram_manager(0), the_track_finding_manager(0)
{
  ...
  cout << "Number of plates found in geometry: " << the_geometry->get_number_of_plates() << endl;
  ...
  the_output_data_structure = new output_data_structure();
  
  the_input_output_manager->initialize_output(the_histogram_manager, the_output_data_structure);
  
  the_cluster_manager = new cluster_manager();
  
  the_transformation_manager = new transformation_manager(the_geometry);
  
  the_track_finding_manager = new track_finding_manager(the_histogram_manager, the_output_data_structure, the_geometry);
}
