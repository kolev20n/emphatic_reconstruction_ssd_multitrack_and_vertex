...
public:
  ...
  bool set_reconstruction_option_algorithm(int an_algorithm);
  bool initialize_output(histogram_manager*& a_histogram_manager, output_data_structure* the_output_data_structure);
