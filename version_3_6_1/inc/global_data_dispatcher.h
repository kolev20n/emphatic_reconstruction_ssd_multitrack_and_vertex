...
public:
  ...
  run_output_data_structure* get_run_output_data_structure();
  void register_run_output_data_structure(run_output_data_structure* a_run_output_data_structure);
  ...
  event_characteristics* get_event_characteristics();
  void register_event_characteristics(event_characteristics* an_event_characteristics);
  
  void record_particle_data();
